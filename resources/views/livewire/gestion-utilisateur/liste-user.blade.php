                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($users as $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset($user->filiale->logo ? '/storage/' . $user->filiale->logo : 'assets/images/image_produit.png') }}"
                                                            alt="" class="rounded-circle avatar-sm">
                                                        {{ $user->filiale ? $user->filiale->nom : 'vide' }}
                                                    </td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="filiale" id="filiale" class="form-control"
                                        wire:model.live="filiale">
